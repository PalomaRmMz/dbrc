...
DELIMITER $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `EXISTEV2`(IN `clave_elector` VARCHAR(256), IN `curp` VARCHAR(256))
BEGIN
	DECLARE gob INT;
	DECLARE dip INT;
