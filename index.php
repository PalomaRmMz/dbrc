...
<body>
    <!-- Inicia Login -->
    <div class="align-items-center justify-content-center login">
        <div class="ventana-login">
            ...
            <form method="post">
                ...
                <div class="form-group">
                    <input class="form-control" type="password" id="pass" autocomplete="off" required>
                </div>
                <button class="btn btn-primary btn-block" type="submit" id="init">Iniciar Sesión</button>
            </form>
        </div>
    </div>
        ...
        <div class="topbar">
            <div class="top-navbar">
                ...
                <form class="form-search" method="post" id="consul01">
                    <input class="form-control form-control-dark" type="text" name="" id="busqueda" placeholder="&#xF002; Consulta de Registro (Clave de Elector)" style="font-family:Arial, FontAwesome" autocomplete="off" maxlength="18" minlength="18">
                ...
                <div class="drop-menu">
                    ...
                    <div class="dropdown-menu">
                        <ul class="menu-inside">
                            ...
                            <li>
                                <a data-toggle="modal" data-target="#modal-suspender"> <i class="fa fa-clock-o"></i> Suspender </a>
                            </li>
                ...
                <nav class="sidebar-nav active">
                    <ul class="in">
                        ...
                        <li class="menu-item ite-link" data-page="comunidad" id="menucomunidad">
                            <a>
                                <i class="fa fa-user-plus" aria-hidden="true"></i><span> Registro de Presidencias de Comunidad</span>
                            </a>
                        </li>
                        ...
                        <div class="tab-pane fade show active" id="pills-propietario" role="tabpanel" aria-labelledby="pills-propietario-tab">
                            ...
                            <div class="form-group" id="CemailDipMP" style="display: none;">
                                ...
                                <input class="form-control" type="email" id="IemailDipMA" name="email" placeholder="usuario@dominio.com" size="30">
                                            ...
                                            <div class="form-group">
                                                <label class="form-control-label">Número de emisión de la credencial para votar<span class="tx-danger">*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label class="form-control-label">CIC (Código de Identificación de Credencial para Votar)<span class="tx-danger"></span></label>
                                            ...
                                            <div class="form-group fadeIn">
                                                ...
                                                <label for="cboPoliticaDP" style="color:#868ba1;font-size: 16px;">He leído y acepto la  <a href="#">
                                ...
                                <div class="split-form">
                                    <div class="marg-form">
                                        <h5 class="titulo"><i class="icon fa fa-file"></i> Documentación del Propietario</h5>
                                        <form method="POST" id="docPropietario">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label form-control-label" for="d-can3">No aplica</label>
                                                </div>
                                            </div>
                                            <div class="form-check">
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label form-control-label">Constancia de separación del cargo de la función pública.</label>
                                                <div class="form-check form-check-inline">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label form-control-label" for="defaultCheck10">
                                                    Escrito bajo protesta de decir verdad, que no se encuentra inhabilitado para ocupar un cargo público y que no se cuenta con antecedentes penales.
                                                </label>
                                            </div>
                                            <div class="form-check">
                            ...
                            <div class="form-group" id="CemailDipMS" style="display: none;">
                                ...
                                <input class="form-control" type="email" id="IemailDipMAS" name="email" placeholder="usuario@dominio.com" size="30" >
                                            ...
                                            <div class="form-group fadeIn">
                                                ...
                                                <label for="cboPoliticaDS" style="color:#868ba1;font-size: 16px;">He leído y acepto la  <a href="#">
                                                Política de Privacidad <span class="tx-danger">*</span>
                                                </a></label>
                                            </div>
                                        </div>
                                ...
                                <div class="split-form">
                                    <div class="marg-form">
                                        <h5 class="titulo"><i class="icon fa fa-file"></i> Documentación del Suplente</h5>
                                        <form id="docSuplente" method="post">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label form-control-label" for="d-canS3">No aplica</label>
                                                </div>
                                            </div>
                                            <div class="form-check">
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label form-control-label">Constancia de separación del cargo o la función pública.</label>
                                                <div class="form-check form-check-inline">
            ...
            <div class="envol-div">
                <div class="titulo-pagina">
                    ...
                    <div>
                        ...
                        <p>Coloque la clave de elector del propietario o suplente de la candidatura al que se le va a completar/modificar información.</p>
                    </div>
                </div>
            ...
            <div class="envol-div">
                ...
                <div class="form-group row justify-content-center form-sust">
                    <form class="row" method="post">
                        ...
                        <button type="submit" class="btn btn-primary col-lg-2 btn-sust"><i class="fa fa-search"></i> Buscar</button>
                    </form>
                </div>
        ...
        <div class="contenido-pagina cancelacion">
            <div class="envol-div">
                <div class="titulo-pagina">
                    ...
                    <div>
                        <h4>Renuncia</h4>
                        <p>Coloque la clave de elector del propietario o suplente que va a renunciar a su candidatura.</p>
                    </div>
                </div>
                <div class="form-group row justify-content-center form-sust">
                    <form class="row" method="post">
                        ...
                        <button type="submit" class="btn btn-primary col-lg-2 btn-canc"><i class="fa fa-search"></i> Buscar</button>
                    </form>
                </div>
                    ...
                    <table class="table enmedio">
                        ...
                        <tbody id="tablaUsuarios">
                            <tr>
                                ...
                                <td>Supervisor</td>
                                <td> <button type="button" class="btn btn-primary btn-sm edit-user"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button> <button type="button" class="btn btn-secondary btn-sm eliminar-usuario"> <i class="fa fa-times-circle" aria-hidden="true"></i> Eliminar</button>
                    ...
                    <form>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="defaultCheck10">
                                Escrito bajo protesta de decir la verdad de que no se encuentra inahbilitado para ocupar un cargo público.
                            </label>
                        </div>
                        <div class="form-check">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <br>
                    <small class="text-center">Los aspirantes a candidaturas tendrán hasta 48 hrs para subsanar la información y documentos faltantes. </small>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
    ...
    <div class="modal fade" id="modal-adminuser" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title modal-dialog-centered titulo-adminuser" id="modal-adminuser">Añadir / Usuario</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                            ...
                            <div class="form-check disabled">
                                <label class="form-check-label">5.- Copia certificada del Acta de Nacimiento del padre o madre Tlaxcalteca</label> <br>
                                <div class="form-check form-check-inline">
                            ...
                            <div class="form-check disabled">
                                <label class="form-check-label">8.- Constancia de Separación de cargo publico</label> <br>
                                <div class="form-check form-check-inline">
                            ...
                            <div class="form-check disabled">
                                ...
                                <label class="form-check-label" for="doc-9">
                                    9.- Escrito bajo protesta de decir verdad que no se encuentra inhabilitado parqa ocupar un cargo público y que no se cuenta con antecedentes penales.
                                </label>
                            </div>
                            <div class="form-check disabled">
                            ...
                            <div class="form-check disabled">
                                <label class="form-check-label">16.- CONSTANCIA DE AUTORIZACIÓN DEL ÓRGANO PARTIDISTA EN CASO DE RELECCIÓN</label> <br>
                                <div class="form-check form-check-inline">
                            ...
                            <div class="form-check disabled">
                                <label class="form-check-label">17.- MANIFESTACIÓN DE AUTOADSCRIPCIÓN INDÍGENA</label> <br>
                                <div class="form-check form-check-inline">
                            ...
                            <div class="form-check disabled">
                                <label class="form-check-label">18.- CONSTANCIAS QUE ACREDITEN EL VÍNCULO COMUNITARIO</label> <br>
                                <div class="form-check form-check-inline">
                ...
                <div class="modal-footer foot-modal">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                    <a type="button" class="btn btn-primary" id="imprimir-reporte"><i class="fa fa-print"></i> Re-imprimir Reportes</a>
