...
<body>
    ...
    <div class="dashboard">
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow pe-5">
            ...
            <form class="form-search" method="post" id="consul01" style="width: 70%;">
        ...
        *********************************************************
        ...
        <div class="contenido-pagina registro">
            <div class="envol-div">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" id="form-prueba" class="row adduser-form">
                            <div class="col-md-6">
                ...
                <div id="rdContainer" class="card mt-3" style="width: 100%;">
                    <div class="card-header">
                        Datos candidato
                    </div>
                    <div class="card-body ">
                        <form id="registroPropietario" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-check" id="boxDipMP">
                                ...
                                <div class="form-group col-md-4" id="CemailDipMP" style="display: none;">
        ...
        <div class="contenido-pagina usuarios">
            <div class="envol-div">
                ...
                <button type="button" class=" btn btn-secondary btn-sm update-user">
                    <i class="fa fa-refresh" aria-hidden="true"></i> Actualizar vista de usuarios
                </button>
                <button type="button" class="btn btn-primary btn-sm add-user text-end">
                    ...
                    <form method="post" id="add-user">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label">Nombre(s) <span class="tx-danger">*</span></label>
                                    <input type="text" class="form-control text-uppercase" id="user-name" onkeypress="return  restriccionNombre(event)">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label">Apellido Paterno <span class="tx-danger">*</span></label>
                                    <input type="text" class="form-control text-uppercase" id="user-app" onkeypress="return  restriccionNombre(event)">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label">Apellido Materno <span class="tx-danger">*</span></label>
                                    <input type="text" class="form-control text-uppercase" id="user-apm" onkeypress="return  restriccionNombre(event)">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label">Usuario <span class="tx-danger">*</span></label>
                                    <input type="text" class="form-control text-uppercase" id="user-username" onkeypress="return  restriccion(event)" maxlength="20" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
