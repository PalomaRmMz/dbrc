                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control text-uppercase" id="user-name"
                                        onkeypress="return  restriccionNombre(event)">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label">Apellido Paterno <span
                                            class="tx-danger">*</span></label>
                                    <input type="text" class="form-control text-uppercase" id="user-app"
                                        onkeypress="return  restriccionNombre(event)">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label">Apellido Materno <span
                                            class="tx-danger">*</span></label>
                                    <input type="text" class="form-control text-uppercase" id="user-apm"
                                        onkeypress="return  restriccionNombre(event)">
                                </div>
                            </div>
                            <div class="col-md-4">
