...
FROM candidatura_diputado WHERE clave_elector = '".$clave_electores."' ");
    ...
    $filass = array(
     ...
     $str = $DB_con->prepare("SELECT * FROM registro WHERE clave_original =  '".$clave_elector."'AND tipo_doc ='RSCARGOPLURIcopia' ORDER BY id DESC LIMIT 1 ");
     $str->execute();
...
//  header("Content-Type: text/html; charset=iso-8859-1 ");
  ...
  $pdf->SetFont('Arial','I',9);
	 ...
	 $pdf->Text(10,290,utf8_decode('Clave-Unica: '.sha1(date("h:i:sa")).' '));
