<?php
  ...
  SELECT
	...
	candidatura_gubernatura.user_capturista
...
//  header("Content-Type: text/html; charset=iso-8859-1 ");
  ...
  $pdf->SetFont('Arial','',12);
	...
	$pdf->MultiCell(180,6, utf8_decode('Por medio del presente escrito y en cumplimiento con los artículos 60, párrafo segundo de la Constitución Política del Estado Libre y Soberano de Tlaxcala, 152 fracción IV y 155 párrafo segundo de la Ley de Instituciones y Procedimientos Electorales para el Estado de Tlaxcala, me permito requerirle a la/el ciudadano/a '.$fila['nombre'].' '.$fila['apellido_paterno'].' '.$fila['apellido_materno'].' para ser registrado/a como candidato/a al cargo de GUBERNATURA, CONSTANCIA DE SOLICITUD DE SEPARACIÓN DEL CARGO O FUNCIÓN PÚBLICA, misma que deberá ser entregado a esta autoridad administrativa electoral, hasta antes del día dos de mayo del dos mil dieciocho, lo anterior por ser necesaria para la procedencia de su registro, dentro del Proceso Electoral Local Ordinario 2020-'.date('Y').'.'),0,'J', 0 );
	$pdf->Ln(10);
	$pdf->SetFont('Arial','',12);
