<?php
 ...
 $candidatura = $_GET["candidatura"];
  ...
  CONCAT( candidatura_diputado.distrito, '-' , distrito.nombre ) as distritoName,
  candidatura_diputado.fec_nacimiento,
  candidatura_diputado.genero,
  candidatura_diputado.clave_elector,
  candidatura_diputado.distrito,
...
WHERE candidatura_diputado.clave_elector = '$clave_elector' AND candidatura_diputado.candidatura = $candidatura
...
AND distrito.id_distrito =  candidatura_diputado.distrito");
  ...
  if($res->num_rows < 1 ) {
    ...
    $fila = array(
      ...
      "distrito" => $candidatos["distritoName"],
