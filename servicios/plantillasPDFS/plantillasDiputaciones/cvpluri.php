...
FROM candidatura_diputado, tipo_eleccion, partidos_politicos, distrito
WHERE clave_elector = '$clave_elector' AND candidatura = $candidatura
AND candidatura_diputado.candidatura = tipo_eleccion.id_eleccion
